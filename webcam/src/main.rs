...
//
//    let configuration_page = adw::NavigationPage::builder()
//        .title("Aura Scan")
//        .child(&toolbar)
//        .build();
//
//    let display_page_toolbar = adw::ToolbarView::builder().build();
//
//    let display_page_headerbar = adw::HeaderBar::builder().build();
//    display_page_toolbar.add_top_bar(&display_page_headerbar);
//
//    let display_page = adw::NavigationPage::builder()
//        .child(&display_page_toolbar)
//        .build();
//
//    let navigation_split_view = adw::NavigationSplitView::builder()
//        .vexpand(true)
//        .hexpand(true)
//        .max_sidebar_width(230.0)
//        .sidebar(&configuration_page)
//        .content(&display_page)
//        .build();
//    toasts.set_child(Some(&navigation_split_view));
//
